...
{
    /// <summary>
    /// This script adds the ext UI menu options to the Unity Editor.
    /// </summary>

    static internal class MenuOptionsExtended
    {
        ...
        [MenuItem("GameObject/UI/Button Extended", false, 2031)]
        static public void AddButtonExt(MenuCommand menuCommand)
        {
            GameObject go = CreateButtonExt();
            PlaceUIElementRoot(go, menuCommand);
        }

        public static GameObject CreateButtonExt()
        {
            GameObject uiElementRoot = new GameObject("Button");

            Image image = uiElementRoot.AddComponent<Image>();
            image.type  = Image.Type.Sliced;

            uiElementRoot.AddComponent<ButtonExtended>();
