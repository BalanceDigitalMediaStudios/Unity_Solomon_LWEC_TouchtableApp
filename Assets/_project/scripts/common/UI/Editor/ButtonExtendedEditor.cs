...
//I HAVE TO REWRITE THE WHOLE SELECTABLE EDITOR SO I CAN INSERT MY PROPERTIES WHERE I WANT INSTEAD OF AT THE BEGINNING / END
namespace UnityEditor.UI
{
    ...
    public class ButtonExtendedEditor : Editor
    {
        ...
        //ButtonExt properties
        SerializedProperty m_targetGraphics;   
        SerializedProperty m_excludedGraphics;
        ...
        private static List<ButtonExtendedEditor> s_Editors = new List<ButtonExtendedEditor>();
        private static bool s_ShowNavigation = false;
        private static string s_ShowNavigationKey = "ButtonExtEditor.ShowNavigation";

        // Whenever adding new SerializedProperties to the ButtonExt and ButtonExtEditor
        // Also update this guy in OnEnable. This makes the inherited classes from ButtonExtEditor not require a CustomEditor.
        ...
        protected virtual void OnEnable()
        {
            ...
            m_targetGraphics        = serializedObject.FindProperty("_targetGraphics");
            m_excludedGraphics      = serializedObject.FindProperty("excludedGraphics");
            m_onClick               = serializedObject.FindProperty("m_OnClick");


            (target as ButtonExtended).UpdateGraphics();
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            ++EditorGUI.indentLevel;
            {
                ...
                {
                    EditorGUILayout.PropertyField(m_TargetGraphicProperty, new GUIContent("Parent Graphic"));                    
                }
                if(trans == Selectable.Transition.ColorTint)
                {
                    //ButtonExt properties inserted here
                    EditorGUILayout.PropertyField(m_excludedGraphics);

                    EditorGUI.BeginDisabledGroup(true);            
                    EditorGUILayout.PropertyField(m_targetGraphics);
            ...
            //Button properties inserted here
            EditorGUILayout.Space();
