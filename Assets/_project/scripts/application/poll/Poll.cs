...
public class Poll : UnlockActivity{
    ...
    public override void Open(StickerSpawner spawner){
        ...
        //enable question and disable results
    ...
    IEnumerator GoToResultsRoutine(){
        ...
        //disable selecting any more buttons
        ...
        //slide out question title to the left, while sliding in results title from the right
        ...
        yield return StartCoroutine(SlideRoutine(slides.ToArray(), "x", 0, 0, optionsSlideInterval));
    ...
    void SetTally(PollQuestionData question, Poll_Answer answer, int value){
        ...
        PlayerPrefs.SetInt(GetPrefId(question, answer), 0);
    }
